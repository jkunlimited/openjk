...
AppVerName=v0.1 Alpha
AppVersion=0.1.0.0
AppPublisher=JKU Development Team
AppPublisherURL=https://www.moddb.com/mods/jediknightunlimited
AppSupportURL=https://discord.gg/eEeMaHX
...
Source: {#JKUBuildDirectory}\installer\jku_license.rtf; DestDir: {app}\jku; Flags: ignoreversion; Components: gamefiles
