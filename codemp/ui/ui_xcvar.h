...
XCVAR_DEF( ui_char_anim,					"BOTH_MENU_IDLE",		NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_color_blue,				"255",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_color_green,				"255",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_color_red,				"255",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_model,					"jedi_tf",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_skin_head,				"head_a1",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_skin_legs,				"lower_a1",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_char_skin_torso,				"torso_a1",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
