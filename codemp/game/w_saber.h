...
#define SABER_BLOCK_DEFAULT_FORCE_COST 15

#define SABER_BLOCK_FAST_ATTACK_FORCE_COST 15
#define SABER_BLOCK_MEDIUM_ATTACK_FORCE_COST 20
#define SABER_BLOCK_STRONG_ATTACK_FORCE_COST 25
#define SABER_BLOCK_DUAL_ATTACK_FORCE_COST 18
#define SABER_BLOCK_STAFF_ATTACK_FORCE_COST 18

//These are multiplied on, so in reverse (60% less)
#define SABER_BLADE_BLOCK_COST_FACTOR 0.4f
#define SABER_CONE_BLOCK_COST_FACTOR 0.5f
#define SABER_STANDARD_BLOCK_COST_FACTOR 1.0f
