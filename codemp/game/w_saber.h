...
#define SABER_BLOCK_DEFAULT_FORCE_COST 5

#define SABER_BLOCK_FAST_ATTACK_FORCE_COST 5
#define SABER_BLOCK_MEDIUM_ATTACK_FORCE_COST 5
#define SABER_BLOCK_STRONG_ATTACK_FORCE_COST 5
#define SABER_BLOCK_DUAL_ATTACK_FORCE_COST 5
#define SABER_BLOCK_STAFF_ATTACK_FORCE_COST 5
