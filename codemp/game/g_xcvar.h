...
XCVAR_DEF( g_spawnInvulnerability,				"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_speed,								"200",			NULL,				CVAR_NONE,										qtrue )
...
// JKU Begin
XCVAR_DEF( jku_angle_unblockable,				"45",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( jku_angle_blockable,					"60",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
XCVAR_DEF( jku_timer_damage_invulnerability,	"125",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
// JKU End
